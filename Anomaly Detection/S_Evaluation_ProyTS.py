...
if __name__ == '__main__':
    ...
    #######################################
    #error_df,y_pred = analytic_result(case,mode,h5model,model_name,data_pathXV2,data_pathYV2,data_pathXE1,data_pathYE1,custom_object,data_pathXE2,data_pathYE2)
